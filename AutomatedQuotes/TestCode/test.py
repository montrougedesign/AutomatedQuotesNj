    ...
    if list_length >= 1:
        ...
        if text_list_length == 1:
            if text_list[0] == "WL1":
                ...
                print("\n" + time.asctime() + '\n' + from_ + end)
                sendserver.sendmail('wassermansnews@gmail.com', from_ ,end)
            ...
            if text_list[1] == "ALL":
                ...
                sendserver.sendmail('wassermansnews@gmail.com', from_ , all)
                ...
                sendserver.sendmail('wassermansnews@gmail.com', from_ , last)
                ...
                sendserver.sendmail('wassermansnews@gmail.com', from_ , "Sorry we don't have that.")
